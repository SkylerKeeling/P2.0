...
export default function Blog() {
  return (
    <div style={({minWidth: "450px"}, {minHeight: "1070px"})}>
      <div class="grid grid-cols-2 ">
        <div class="h-screen flex flex-col items-center ">
          {/* Card */}
          <div
            style={{maxWidth: "450px"}}
            class="max-w-sm m-4 bg-white border justify-self-center border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700"
          >
            <a href="#">
              <img
